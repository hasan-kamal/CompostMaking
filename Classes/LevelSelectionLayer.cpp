...
bool LevelSelectionLayer::init(GameScene *gs){
    ...
    touchEventListener->onTouchBegan = CC_CALLBACK_2(LevelSelectionLayer::onTouchBegan, this);
...
bool LevelSelectionLayer::onTouchBegan(cocos2d::Touch *touch, cocos2d::Event *unused_event){
    if(showing){
        dismiss();
        return true;
    }
...
void LevelSelectionLayer::dismiss(){
    auto visibleSize = Director::getInstance()->getVisibleSize();
